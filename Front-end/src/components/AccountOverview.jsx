...
const AccountOverview = () => {
  ...
  return (
    <div className="account-overview">
      ...
      <Card className="mb-4 account-card">
        <Card.Header className="bg-white">
          <h5 className="mb-0">Password and Security</h5>
        </Card.Header>
        <Card.Body>
          <Row className="mb-3 align-items-center">
            ...
            <Col md={9} className="account-value position-relative">
              <div className="password-field d-flex align-items-center">
                <span className="me-2">{showPassword ? "Secret makes a woman woman" : userData.password}</span>
      ...
      <Card className="account-card">
        <Card.Header className="bg-white">
          <h5 className="mb-0">Link Account</h5>
        </Card.Header>
        <Card.Body>
