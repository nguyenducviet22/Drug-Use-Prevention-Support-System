...
const Logo = ({ size = 'medium', variant = 'horizontal' }) => {
    ...
    >
      ...
      <div 
        style={{
          ...
          inset: 0,
          borderRadius: '50%',
          background: 'linear-gradient(135deg, #34d399 0%, #14b8a6 30%, #0891b2 70%, #0e7490 100%)',
      ...
      <div 
        style={{
          ...
          padding: '10px',
          boxShadow: 'inset 0 2px 4px 0 rgba(0, 0, 0, 0.06), inset 0 -2px 4px 0 rgba(0, 0, 0, 0.03)',
          width: '100%',
          height: '100%',
          display: 'flex',
          alignItems: 'center',
  ...
  if (variant === 'icon-only') {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ ...sizeClasses[size], display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <LogoIcon />
        </div>
      </div>
    );
  ...
  return (
    <div style={{ ...sizeClasses[size], display: 'flex', alignItems: 'center', gap: '20px' }}>
      <LogoIcon />
      <LogoText />
    </div>
  );
