...
const EventDetails = ({ isPreview }) => {
  ...
  return (
    <Container className="event-details-container py-4">
                    ...
                    if (!registerDisabled) {
                      ...
                      fetch(
                        ...
                        .then(async (res) => {
                          ...
                          toast.success(
                            <strong>{t("successRegister")}</strong>
                          );
                          setStatusInfo((prev) => ({
                            ...prev,
                            status: "REGISTERED",
      ...
      {!isPreview && <Recommendation type="event" />}
      {!isPreview && <ToastContainer position="top-right" />}
    </Container>
  );
};
