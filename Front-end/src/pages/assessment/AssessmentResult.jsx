...
const AssessmentResult = () => {
  ...
  // Xử lý trường hợp guest (id === "temp" và có location.state)
          ...
          <Card className="result-card">
            ...
            <div className="results-details">
              ...
              <div className="detail-item">
                ...
                <span
                  className={`detail-value risk-${resultData.riskLevel.toLowerCase()}`}
                >
            ...
            <div className="warning-section">
              ...
              <div className="next-steps">
                ...
                {t("mainResultCard.warningSection.recommendations", {
                  returnObjects: true,
                }).map((recommendation, index) => (
                  <div className="recommendation-item" key={index}>
                    {recommendation.title.includes("Course") && (
                      <BookOpen size={18} className="recommendation-icon" />
                    )}
                    {recommendation.title.includes("Advice") && (
                      <MessageCircle
                        size={18}
                        className="recommendation-icon"
                      />
                    )}
                    {recommendation.title.includes("Community") && (
